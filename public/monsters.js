...
// ── Monster definitions ───────────────────────────────────────────────────────
const MONSTER_DEFS = {
  green_slime:   { name:'Green Slime',    tier:'D', hp:30, atk:6,  def:2, xp:15, skills:['m_slam'] },
  blue_slime:    { name:'Blue Slime',     tier:'D', hp:25, atk:5,  def:1, xp:12, skills:['m_splash'] },
  goblin:        { name:'Goblin Scout',   tier:'C', hp:55, atk:12, def:5, xp:30, skills:['m_strike','m_stab'] },
  forest_archer: { name:'Forest Archer',  tier:'C', hp:45, atk:14, def:3, xp:35, skills:['m_shot','m_pierce'] },
  forest_shaman: { name:'Forest Shaman',  tier:'B', hp:90, atk:18, def:8, xp:80, skills:['m_hex','m_curse'] },
};
